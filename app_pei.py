...
if st.session_state.get('modulo_atuacao') == "📂 Administrativo" and st.session_state.get('nav_adm') == "📚 Preparatório ADE":
    ...
    # ==========================================================================
    # 2. MATRIZ EXHAUSTIVA DE 100% DO EDITAL (NENHUM TÓPICO DE FORA)
    # ==========================================================================
    COMPETENCIAS_EDITAL = [
        # --- BLOCO 1: FUNDAMENTOS FILOSÓFICOS, SOCIOCULTURAIS, PSICOLÓGICOS E PEDAGÓGICOS ---
        Competency("ED.01.FUND", "Fundamentos", "Fundamentos Filosóficos, Socioculturais e Pedagógicos", "Relação entre sociedade, escola e conhecimento.", "CORTELLA, M. S. A escola e o conhecimento", 0.9),
        Competency("ED.02.SOC", "Fundamentos", "Função Social da Escola e Concepções de Educação", "Concepções de educação, escola e a construção do conhecimento.", "SAVIANI, D. Pedagogia Histórico-Crítica", 0.9),
        Competency("ED.03.HIST", "Fundamentos", "História da Educação e Pedagogia Crítica", "Evolução histórica da educação escolar e fundamentos da pedagogia crítica.", "LIBÂNEO; OLIVEIRA; TOSCHI. Educação Escolar", 0.85),
        Competency("ED.04.TEOR", "Fundamentos", "Teóricos da Educação (Freire, Saviani, Libâneo, Cortella)", "Concepções de ensino de grandes autores da pedagogia brasileira.", "FREIRE; SAVIANI; LIBÂNEO; CORTELLA", 0.95),
        Competency("ED.05.PSIQ", "Fundamentos", "Desenvolvimento do Psiquismo e Psicologia", "Contribuições à luz da Psicologia Histórico-Cultural e Pedagogia Histórico-Crítica.", "MARTINS, L. M. O desenvolvimento do psiquismo", 0.85),
        Competency("ED.06.SOCIO", "Fundamentos", "Formação Pessoal e Social do Educando", "Desenvolvimento integral, afetivo e social do estudante.", "Diretrizes Nacionais para a Educação Básica", 0.8),
        Competency("ED.07.FORM", "Fundamentos", "Formação Continuada", "Desenvolvimento profissional contínuo dos educadores e prática reflexiva.", "VASCONCELOS, M. L. Educação básica: a formação do professor", 0.8),

        # --- BLOCO 2: CURRÍCULO, DIDÁTICA E APRENDIZAGEM ---
        Competency("CUR.01.CUR", "Currículo e Didática", "Currículo e Território em Disputa", "Concepções de currículo, diversidade e disputas territoriais e culturais.", "ARROYO, M. G. Currículo, Território em Disputa", 0.85),
        Competency("CUR.02.DID", "Currículo e Didática", "Didática e Metodologia de Ensino", "O processo de ensino e aprendizagem, métodos e a práxis pedagógica.", "LIBÂNEO, J. C. Didática", 0.9),
        Competency("CUR.03.COMP", "Currículo e Didática", "Ensino por Competências e BNCC", "Mobilização de conhecimentos, habilidades, atitudes e valores.", "Base Nacional Comum Curricular (BNCC)", 0.9),
        Competency("CUR.04.PROJ", "Currículo e Didática", "Projeto Político-Pedagógico e Planejamento", "Elaboração, execução e avaliação do PPP e do projeto de ensino-aprendizagem.", "VASCONCELLOS, C. S. Planejamento: Projeto de Ensino e PPP", 0.95),
        Competency("CUR.05.LEIT", "Currículo e Didática", "Leitura, Escrita e Resolução de Problemas", "Processos de letramento, alfabetização e desenvolvimento do raciocínio lógico.", "Currículo da Rede Municipal de Limeira", 0.9),

        # --- BLOCO 3: GESTÃO ESCOLAR, ORGANIZAÇÃO E TRABALHO COLETIVO ---
        Competency("GES.01.POL", "Gestão Escolar", "Políticas, Estrutura e Organização da Escola", "Políticas públicas educacionais e organização sistêmica da escola.", "LIBÂNEO; OLIVEIRA; TOSCHI. Educação Escolar", 0.85),
        Competency("GES.02.COL", "Gestão Escolar", "Participação e Trabalho Coletivo na Escola", "Educação e supervisão, redes de saberes e ação coletiva na escola.", "ALVES, N. Educação e Supervisão", 0.85),
        Competency("GES.03.PARO", "Gestão Escolar", "Administração Escolar e Gestão Democrática", "Crítica à administração empresarial, gestão democrática, conselhos escolares e o papel do diretor.", "PARO, V. H. Administração escolar; Gestão democrática; Diretor escolar", 0.95),
        Competency("GES.04.LUCK", "Gestão Escolar", "Liderança e Gestão de Pessoas (Heloísa Lück)", "Concepções e processos democráticos, liderança educacional e gestão de desempenho por indicadores.", "LÜCK, H. Séries Cadernos de Gestão (v. II, IV, VI)", 0.95),
        Competency("GES.05.SUP", "Gestão Escolar", "Planejamento Estratégico e Ação Supervisora", "Assessoria às unidades escolares e tendências da supervisão educacional.", "POSSANI et al. Ação Supervisora: tendências e práticas", 0.8),
        Competency("GES.06.CONF", "Gestão Escolar", "Mediação e Gestão de Conflitos", "Resolução de conflitos entre comunidade, família, alunos e equipe escolar.", "RANGEL, M. Supervisão e gestão na escola", 0.9),
        Competency("GES.07.DOC", "Gestão Escolar", "Elaboração e Análise de Planos de Ação e Pareceres", "Redação de relatórios pedagógicos, pareceres técnicos e planos estratégicos.", "Manuais de Gestão e Publicações Institucionais", 0.9),
        Competency("GES.08.ESP", "Gestão Escolar", "Organização e Planejamento do Espaço Escolar", "Uso pedagógico e otimização dos espaços físicos da escola.", "Diretrizes Nacionais para a Educação Básica", 0.8),

        # --- BLOCO 4: AVALIAÇÃO E INDICADORES EDUCACIONAIS ---
        Competency("AV.01.REND", "Avaliação e Indicadores", "Avaliação e Acompanhamento do Rendimento Escolar", "Avaliação formativa, diagnóstica e superação do caráter classificatório.", "LUCKESI, C. C. Avaliação da aprendizagem escolar", 0.95),
        Competency("AV.02.IDEB", "Avaliação e Indicadores", "Monitoramento de Indicadores Educacionais", "Análise de índices de rendimento, fluxo escolar, evasão e metas do IDEB.", "MEC / INEP / Indicadores Educacionais", 0.9),

        # --- BLOCO 5: TEMAS CONTEMPORÂNEOS, INCLUSÃO E DIREITOS HUMANOS ---
        Competency("TEM.01.INC", "Temas Contemporâneos", "Educação Inclusiva e AEE", "Política Nacional de Educação Especial Inclusiva (Decreto nº 12.686/2025) e LBI.", "Decreto nº 12.686/2025; LBI (Lei nº 13.146/2015)", 0.95),
        Competency("TEM.02.DH", "Temas Contemporâneos", "Diretrizes Nacionais de Direitos Humanos", "Educação em direitos humanos, cidadania e prevenção de preconceitos.", "Caderno de Educação e Direitos Humanos (SDH/PR)", 0.85),
        Competency("TEM.03.ANT", "Temas Contemporâneos", "Ensino Antirracista e Diversidade Étnico-Racial", "História e Cultura Afro-Brasileira e Indígena (Leis nº 10.639/03 e 11.645/08).", "MOTA, T. H. Ensino antirracista; Leis 10.639/03 e 11.645/08", 0.9),
        Competency("TEM.04.TIC", "Temas Contemporâneos", "Tecnologias de Informação e Comunicação (TIC)", "Educação digital, letramento midiático e uso consciente de dispositivos digitais e telas.", "Lei nº 14.533/2023; Guia de Telas (SECON/PR); Resolução CNE/CEB nº 02/2025", 0.9),
        Competency("TEM.05.SOC", "Temas Contemporâneos", "Prevenção de Acidentes e Primeiros Socorros", "Noções básicas de primeiros socorros nas escolas e prevenção de acidentes (Lei Lucas).", "Lei nº 13.722/2018; Guia MMFDH", 0.85),

        # --- BLOCO 6: LEGISLAÇÃO FEDERAL E NORMATIVAS NACIONAIS ---
        Competency("LEG.CF", "Legislação Federal", "Constituição Federal de 1988 (Artigos 205 a 214)", "Dever do Estado, gratuidade, igualdade de condições e gestão democrática.", "Constituição Federal de 1988", 0.95),
        Competency("LEG.LDB", "Legislação Federal", "LDB (Lei nº 9.394/1996)", "Diretrizes e bases da educação nacional, etapas, níveis, incumbências da escola e docentes.", "Lei nº 9.394/1996", 1.0),
        Competency("LEG.ECA", "Legislação Federal", "Estatuto da Criança e do Adolescente (ECA)", "Direitos fundamentais à educação, proteção escolar e obrigações de comunicação ao Conselho Tutelar (Art. 53 a 56).", "Lei nº 8.069/1990", 0.95),
        Competency("LEG.PNE", "Legislação Federal", "Plano Nacional de Educação (PNE)", "Metas decenais, erradicação do analfabetismo e diretrizes para a qualidade da educação.", "Lei nº 15.388/2026", 0.85),
        Competency("LEG.BNCC", "Legislação Federal", "Base Nacional Comum Curricular (BNCC)", "Competências gerais da educação básica, direitos de aprendizagem e organização curricular.", "MEC / BNCC", 0.9),
        Competency("LEG.DIR", "Legislação Federal", "Diretrizes Curriculares Nacionais Gerais para a Educação Básica", "Qualidade social da educação, diretrizes operacionais para tempo integral e educação infantil.", "Resoluções CNE/CEB nº 04/2010, nº 05/2009 e nº 07/2025", 0.85),
        Competency("LEG.BNC", "Legislação Federal", "BNC-Diretor Escolar", "Base Nacional Comum de Competências do Diretor Escolar.", "Parecer CNE/CP nº 4/2021", 0.9),

        # --- BLOCO 7: LEGISLAÇÃO INSTITUCIONAL E MUNICIPAL DE LIMEIRA ---
        Competency("LIM.EST", "Legislação Local", "Estatuto do Magistério Público de Limeira", "Direitos, deveres, plano de carreira e organização profissional.", "Lei Complementar Municipal nº 461/2009", 0.95),
        Competency("LIM.FUNC", "Legislação Local", "Estatuto dos Funcionários Públicos de Limeira", "Regime jurídico dos servidores públicos municipais.", "Lei Complementar Municipal nº 41/1991", 0.85),
        Competency("LIM.CUR", "Legislação Local", "Currículo e Normativas da Rede Municipal de Limeira", "Currículo municipal (2019), Resolução SME nº 03/2026 e diretrizes locais de ensino.", "Currículo da Rede Municipal de Limeira; Resolução SME nº 03/2026", 0.95),
        Competency("LIM.INF", "Legislação Local", "Plano Municipal pela Primeira Infância de Limeira (PMPI)", "Diretrizes, metas e gestão intersetorial para a primeira infância no município.", "Lei Ordinária nº 7.257/2025 (PMPI Limeira)", 0.9),
        Competency("LIM.ESP", "Legislação Local", "Normas de Educação Especial e Conselho de Escola em Limeira", "Regulamentação local para educação especial (Decreto Municipal nº 23/2026) e Conselho de Escola (Resolução SME nº 01/2020).", "Decreto Municipal nº 23/2026; Resolução SME nº 01/2020", 0.9)
    ]
    ...
    BIBLIOTECA_TEORICA = {
        ...
        "ED.02.SOC": "A função social da escola pública na perspectiva histórico-crítica reside na socialização do saber sistematizado e universal, instrumentalizando as classes trabalhadoras para a intervenção transformadora na sociedade.",
        "ED.03.HIST": "A história da educação revela que a organização escolar foi moldada por disputas políticas e sociais. A pedagogia crítica contrapõe-se aos modelos seletivos do passado, buscando uma escola unitária voltada para a emancipação.",
        "ED.04.TEOR": "Os grandes teóricos da educação convergem na defesa de que o ensino deve superar a memorização passiva. Freire enfatiza o diálogo; Saviani, a apropriação do saber clássico; Libâneo, a mediação didática consciente.",
        "ED.05.PSIQ": "A psicologia histórico-cultural (Vigotski e Martins) demonstra que o desenvolvimento do psiquismo humano é um processo eminentemente social, impulsionado pela educação escolar de qualidade.",
        "CUR.03.COMP": "A BNCC estrutura o ensino por competências, definido como a mobilização complexa de conhecimentos, habilidades, atitudes e valores para resolver demandas da vida real.",
        "GES.03.PARO": "Vitor Paro defende que a administração escolar deve superar a lógica empresarial. A escola pública produz seres humanos emancipados, exigindo gestão democrática com instâncias deliberativas reais.",
        "GES.04.LUCK": "Heloísa Lück define a liderança educacional como um processo de mobilização coletiva em rede, pautada em indicadores de desempenho para o planejamento participativo.",
        "TEM.04.TIC": "A Política Nacional de Educação Digital (Lei nº 14.533/2023) e as diretrizes sobre o uso de telas (SECON/PR / CNE) exigem o letramento midiático crítico, assegurando que o aluno produza e analise informações com ética e segurança.",
        "TEM.05.SOC": "A Lei Lucas (Lei nº 13.722/2018) obriga a capacitação de equipes escolares em primeiros socorros para agir de forma preventiva e imediata em situações de urgência até a chegada do socorro especializado.",
        "LEG.LDB": "A LDB delimita com precisão as incumbências: a escola provê os meios físicos e logísticos para a recuperação (Art. 12), e o docente estabelece as estratégias pedagógicas e zela pela aprendizagem (Art. 13)."
    }
    ...
    for c in COMPETENCIAS_EDITAL:
        if c.id not in ids_questoes_criadas:
            BANCO_QUESTOES_REAIS.append({
                ...
                "gabarito": 1, "explicacao": f"As normativas e a bibliografia oficial ({c.reference}) repudiam a neutralidade e o tecnicismo, defendendo sempre uma educação emancipatória."
            })
    ...
    with aba_matriz:
        ...
        st.divider()
        st.info("💡 **Garantia de Aprovação:** Nenhuma temática do edital ficou de fora. Cada linha desta tabela representa um vetor de conhecimento monitorado pelo nosso motor cognitivo rumo ao seu 1º lugar!")
