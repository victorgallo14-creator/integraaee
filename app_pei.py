...
# ==============================================================================
    ...
    if doc_mode == "PDI":
        ...
        # --- ABA 2: AVALIAÇÃO GERAL (FAMÍLIA E SAÚDE) ---
        with tabs[1]:
            with st.form("pdi_aval_geral"):
                st.header("2. Avaliação Geral")
                
                st.subheader("2.1.1 Gestação, Parto e Desenvolvimento")
