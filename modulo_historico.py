...
def buscar_dados_historico(ra):
    return {
        ...
        "transferencia": {
            "ano": "2026", "turma": "5º Ano 1", "chamada": "15", "transferido_em": "10/05/2026",
            "dias_letivos": "57", "ausencias": "2", "compensadas": "0", "frequencia": "96%",
            "curriculo": {
                "LÍNGUA PORTUGUESA": ["AD", "", ""],
                "GEOGRAFIA": ["AD", "", ""],
                "MATEMÁTICA": ["B", "", ""],
                "CIÊNCIAS": ["AD", "", ""],
                "HISTÓRIA": ["AD", "", ""],
...
def gerar_pdf(dados):
    ...
    t_info.setStyle([
        ('SPAN', (1,0), (4,0)), ('SPAN', (1,1), (4,1)), ('SPAN', (1,2), (4,2)), ('SPAN', (1,5), (4,5)),
        ('LINEBELOW', (1,0), (4,0), 0.5, colors.black), ('LINEBELOW', (1,1), (4,1), 0.5, colors.black),
        ('LINEBELOW', (1,2), (4,2), 0.5, colors.black), ('LINEBELOW', (1,3), (1,3), 0.5, colors.black),
        ('LINEBELOW', (3,3), (3,3), 0.5, colors.black), ('LINEBELOW', (1,4), (1,4), 0.5, colors.black),
        ('LINEBELOW', (3,4), (3,4), 0.5, colors.black), ('LINEBELOW', (1,5), (4,5), 0.5, colors.black),
    ...
    t_sec1 = Table(dados_1, colWidths=[10*mm, 35*mm, 45*mm, 20*mm, 40*mm, 10*mm, 10*mm, 20*mm])
    t_sec1.setStyle([
    ...
    dados_2 = [
        ...
        [celula("<b>CURRÍCULO</b><br/>" + texto_legal, s_legal), "", celula("Anos Iniciais", s_center), "", "", "", ""],
    ...
    # ---------------------------------------------------------
    matriz_456 = [
        [celula("4", s_center), celula("ENSINO RELIGIOSO (art.33-LDB e Deliberação CME nº 02/2016)", s_bold), celula("CARGA HORÁRIA", s_center), "", "", "", ""],
        [celula("5", s_center), celula("<b>EDUCAÇÃO ESPECIAL - ATENDIMENTO EDUCACIONAL ESPECIALIZADO</b><br/>Decreto Nº 12.686/2025 - Indicação Cme Nº02/2023 - Decreto Municipal Nº 23/2026<br/>Indicar a sigla AEE para o estudante que frequentou esse tipo de atendimento.", s_legal), celula("1º ano", s_center), celula("2º ano", s_center), celula("3º ano", s_center), celula("4º ano", s_center), celula("5º ano", s_center)],
        ["", "", celula(regra_do_traco(dados['aee'][0]), s_center), celula(regra_do_traco(dados['aee'][1]), s_center), celula(regra_do_traco(dados['aee'][2]), s_center), celula(regra_do_traco(dados['aee'][3]), s_center), celula(regra_do_traco(dados['aee'][4]), s_center)],
        [celula("6", s_center), celula("TOTAL DA CARGA HORÁRIA (CAMPO 2 + CAMPO 3)", s_bold), celula(dados['ch_total'], s_center), "", "", "", ""]
    ]
    t_456 = Table(matriz_456, colWidths=[10*mm, 80*mm, 20*mm, 20*mm, 20*mm, 20*mm, 20*mm])
    t_456.setStyle(TableStyle([
        ...
        ('BACKGROUND', (2, 1), (6, 1), colors.lightgrey),
    ...
    # ---------------------------------------------------------
    matriz_7 = [
        [celula("7", s_center), celula("ESTUDOS REALIZADOS", s_bold), "", "", ""],
    ...
    # 9, 10 e 11
    # ---------------------------------------------------------
    elementos.append(Table([[celula("9", s_center), celula("OBSERVAÇÕES", s_bold)]], colWidths=[10*mm, 180*mm], style=[('GRID', (0,0), (-1,-1), 0.5, colors.black), ('BACKGROUND', (0,0), (-1,-1), colors.lightgrey)]))
    elementos.append(Table([["\n\n\n"]], colWidths=[190*mm], style=[('GRID', (0,0), (-1,-1), 0.5, colors.black)]))
    
    matriz_10 = [
        [celula("10", s_center), celula("CERTIFICADO", s_bold)],
    ...
    elementos.append(Table(matriz_10, colWidths=[10*mm, 180*mm], style=[
        ('GRID', (0,0), (-1,-1), 0.5, colors.black), 
        ('BACKGROUND', (0,0), (-1,0), colors.lightgrey),
        ('SPAN', (0,1), (0,1))
    ]))
    ...
    matriz_11 = [
        [celula("11", s_center), celula("ASSINATURAS", s_bold), "", ""],
    ...
    t_ass = Table(matriz_11, colWidths=[10*mm, 50*mm, 65*mm, 65*mm])
    t_ass.setStyle([
        ('SPAN', (1,0), (3,0)), 
        ('GRID', (0,0), (-1,-1), 0.5, colors.black), 
